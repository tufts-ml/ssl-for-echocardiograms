...
export scales=4
export train_dir="../../experiments/table5/PretrainedMixMatch/fold0"
...
export checkpoint_exclude_scopes="dense,batch_normalization_32,conv2d_36"
