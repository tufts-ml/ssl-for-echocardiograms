...
def main(argv):
    ...
    for report_type in ['RAW_BalancedAccuracy', 'EMA_BalancedAccuracy']:
        ...
        perform_analysis(figure_title, experiment_dir, result_save_dir, num_bootstrap_samples, bootstrap_upper_percentile, bootstrap_lower_percentile, ylim_lower, ylim_upper, report_type, task_name)
