...
class MixMode:
    ...
    def __call__(self, xl: list, ll: list, betal: list): #xl: a list of images: [labeled, unlabeled_1, unlabeled_2], ll:a list of one-hot labels: [labeled, unlabeled_1, unlabeled_2], note: for unlabeled_1 and unlabeled_2 labels are the same 
